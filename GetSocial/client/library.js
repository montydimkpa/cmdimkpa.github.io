...
const messageBox = (message) => {
    return `<div class="container darker"><p><b>${message.from}: </b>${message.text}</p><span class="time-left">${message.timestamp}<span><img src="https://cmdimkpa.github.io/GetSocial/client/reply.gif" alt="reply" width="50"></span></span></div>`
}
